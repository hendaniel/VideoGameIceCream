...
public class PowerBIG {
    ...
    public PowerBIG (Context context, float screenWidth, float screenHeigth){
        borrar = false;
        Random randomGenerator = new Random();
        speed = randomGenerator.nextInt(8);
        positionX = this.INIT_X;
        positionY = randomGenerator.nextInt(1000)+1;
        //Getting bitmap from resource
        Bitmap originalBitmap= BitmapFactory.decodeResource(context.getResources(), R.drawable.star);
